package han.anthony.anthonydemo.activity_quick24;
...
public class Quick24Activity extends AppCompatActivity {
    ...
    private static final String TAG = "Quick24Activity";
    //保存所有可能位置的数字集合,如1 2 3 4, 2 4 1 3....
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quick24);
        setTitle("快算24");
        mEt1 = $(R.id.et_num1);
        mEt2 = $(R.id.et_num2);
        mEt3 = $(R.id.ev_num3);
